...
class OperateElement():
    ...
    def get_info(self,mOperate):
        return mOperate["element_info"]
...
def operate_click(mOperate,cts):
    if mOperate["find_type"] == common.find_element_by_id  or mOperate["find_type"] == common.find_element_by_xpath or mOperate["find_type"] ==common.find_element_by_android_uiautomator:
        elements_by(mOperate, cts).click()
    if mOperate["find_type"] == common.find_elements_by_id  or mOperate["find_type"] ==common.find_elements_by_android_uiautomator:
...
def elements_by(mOperate, cts):
    elements = {
        ...
        common.find_element_by_android_uiautomator:lambda :cts.find_element_by_android_uiautomator('new UiSelector().description('+"\""+mOperate["element_info"] +"\""+")")
    }
