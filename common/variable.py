...
class GetVariable(object):
    ...
    find_element_by_android_uiautomator = "by_uiautomator"
    find_elements_by_android_uiautomator = "by_uiautomators"
    SELENIUM = "selenium"
    APPIUM = "appium"
    ANDROID = "android"
    # IOS = "ios"
    ...
    PROTOCOL = "http://" #协议
    APACHE_PATH = "D:/app/Apache2.2/htdocs/appium/log/" #apapche服务器的地址，开发可以在这个上面下载异常日志
